...
function HighlightArticle() {
  return (
    <button data-reveal className="group relative block h-[380px] w-full shrink-0 overflow-clip rounded-xl text-left shadow-[0px_1px_2px_0px_rgba(204,204,204,0.14),0px_5px_5px_0px_rgba(204,204,204,0.12),0px_10px_6px_0px_rgba(204,204,204,0.07)] xl:h-[464px] xl:w-[492px]">
...
function ArticleItem({ article }: { article: (typeof NEWS_ARTICLES)[number] }) {
  return (
    <button data-reveal className="group flex h-[264px] w-[307px] shrink-0 flex-col overflow-clip rounded-xl border border-neutral-300 bg-white text-left shadow-[0px_1px_2px_0px_rgba(204,204,204,0.14),0px_5px_5px_0px_rgba(204,204,204,0.12),0px_10px_6px_0px_rgba(204,204,204,0.07)] xl:h-36 xl:w-full xl:flex-row xl:items-center">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[560px] px-4 xl:w-[1280px] xl:max-w-none xl:px-0">
        ...
        <div data-reveal-group className="mt-6 xl:mt-10 xl:flex xl:gap-26">
          ...
          <div data-reveal className="hidden h-[464px] w-44 shrink-0 flex-col items-start justify-between pb-4 xl:flex">
            ...
            <button className="flex items-center gap-0.5 text-base font-semibold text-blue-500 transition-transform hover:translate-x-0.5">
              Lihat Lebih Banyak
