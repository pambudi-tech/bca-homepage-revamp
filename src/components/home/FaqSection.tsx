...
export default function FaqSection() {
  ...
  return (
    <section id="faq-section" className="relative flex h-[640px] items-center overflow-clip">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[560px] justify-center px-4 xl:w-[1280px] xl:max-w-none xl:justify-end xl:px-0">
        <div data-reveal className="w-full max-w-[640px] overflow-clip rounded-3xl bg-white shadow-[0px_1px_2px_0px_rgba(204,204,204,0.14),0px_5px_5px_0px_rgba(204,204,204,0.12),0px_10px_6px_0px_rgba(204,204,204,0.07)]">
          ...
          <div className="hide-scrollbar flex items-center gap-4 overflow-x-auto border-b border-neutral-300 bg-white px-4 pt-2 [scrollbar-width:none] xl:gap-4 xl:px-6">
            {FAQ_CATEGORIES.map((cat) => {
              ...
              return (
                ...
                >
                  <span
                    className={`flex w-full flex-1 items-center justify-center whitespace-nowrap px-3 text-sm xl:text-base ${
          ...
          <div
            data-lenis-prevent
            className="flex h-[240px] flex-col gap-1 overflow-y-auto bg-white px-2 py-2 xl:px-4"
          >
