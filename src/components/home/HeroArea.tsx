...
export default function HeroArea({ kurs, banners }: { kurs: KursEntry[]; banners: Slide[] }) {
  return (
    <div className="relative z-10">
      ...
      <div
        className="absolute inset-x-0 z-20 px-4 xl:hidden"
        style={{ bottom: 248 }}
      >
        <MobileHeroSearch />
      </div>
      <div className="absolute inset-x-0 bottom-[84px] z-20 overflow-hidden xl:bottom-[116px] xl:left-1/2 xl:right-auto xl:w-[1280px] xl:-translate-x-1/2 xl:overflow-visible">
